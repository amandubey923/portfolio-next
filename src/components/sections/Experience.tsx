import { Trophy, Terminal, Cpu, CheckCircle2 } from "lucide-react";
...
const experiences: TimelineItem[] = [
  ...
  },
  {
    ...
    period: "500+ Problems",
    icon: Cpu,
    context: "500+ DSA Problems Solved // Algorithmic Optimization",
    points: [
      "Solved 500+ algorithmic problems across LeetCode and GeeksforGeeks platforms.",
      "Developed deep mastery in asymptotic complexity analysis, arrays, strings, trees, and graph algorithms in C++.",
  ...
  },
  {
    ...
    period: "2023 – Present",
    icon: Terminal,
    context: "Independent Full-Stack & AI Project Development",
    points: [
  ...
  return (
    <section id="experience" className="relative scroll-mt-24 py-12 md:py-16">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        {/* ================= TIMELINE CONTAINER (3 FOCUSED CARDS) ================= */}
